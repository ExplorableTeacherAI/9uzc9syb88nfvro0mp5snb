      ...
      <Section id="minimax-regret-concept" padding="md">
        ...
        <InteractiveParagraph>
          <Hoverable tooltip="The difference between what you actually got and what you could have gotten if you had made the best choice for that particular outcome.">
            Regret
          </Hoverable>{" "}measures the "what if" feeling — the gap between what you got and what you could have gotten. For example, if you chose Product B and earned <strong>$150k</strong>, but Product A would have earned <strong>$200k</strong>, your regret is <strong>$50k</strong>. It's not a loss, but a missed opportunity.
        </InteractiveParagraph>
      </Section>
